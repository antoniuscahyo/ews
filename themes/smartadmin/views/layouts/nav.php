			...
			<div class="login-info">
				<span> <!-- User image size is adjusted inside CSS, it should stay as it --> 
					...
					<a href="javascript:void(0);" id="show-shortcut">
						<img src="upload/pengguna/<?php echo Yii::app()->user->foto; ?>" alt="me" class="online" /> 
						<span>
							<b style="color: white"><?php echo Yii::app()->user->nama_pengguna; ?></b>
						</span>
				...
				<ul>
					<?php
						foreach ($page_nav as $key => $nav_item) {
							...
							if ($url=='backend/buku_tamu') {
								if (!Yii::app()->user->isGuest/* && Tblrole::model()->isRole('SUPERADMIN')*/) {
									$label_htm = '<span id="jumlahAduan" class="badge bg-color-red pull-right inbox-badge margin-right-13"></span>';
								}
							}
