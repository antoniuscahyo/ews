...
<!-- POSSIBLE CLASSES: minified, fixed-ribbon, fixed-header, fixed-width
		...
		?>
				<!-- HEADER -->
				<header id="header" style="background: #fff;border-bottom: 2px solid #61ba6d;">
					<div id="logo-group">

						<!-- PLACE YOUR LOGO HERE -->
						<span id="logo"> <img src="<?php echo ASSETS_URL; ?>/img/images/logo.png" style="width: 115%;margin-top: -12px;margin-right: 200px ! important;" alt="Administrator"> </span>
