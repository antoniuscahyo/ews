 ...
 */
 ...
 $(document).ready(function() {
	 ...
	 */
	 // cek();
	 // setInterval(function()  {cek()}, 60000);
...
function notifikasi_gagal(title, msg, type, istimeout, isrefresh) {
	if (type=='success') {
		var warna = '#296191';
		var icon = 'fa-save';
		if(isrefresh==null || isrefresh==true) 
...
function wait(ms) {
	...
	function reloadDT(idelement) {
		var base_url = 'themes/smartadmin/';
		loadScript(base_url+"ajs/datatables/jquery.dataTables.min.js", function(){
			loadScript(base_url+"ajs/datatables/dataTables.colVis.min.js", function(){
				loadScript(base_url+"ajs/datatables/dataTables.tableTools.min.js", function(){
					loadScript(base_url+"ajs/datatables/dataTables.bootstrap.min.js", function(){
						loadScript(base_url+"ajs/datatables/datatables.responsive.min.js", pagefunction)
					});
				});
			});
		});
	...
	function cek() {
		/*alert('asdasdasfasf');*/
		$.get('backend/buku_tamu/cek', function(respon) {
			$("#notif_masuk").html('<i class="fa fa-envelope"></i> '+respon+' Buku Tamu Masuk');
			if (respon>0) {
	...
	function drawTablePipeLine(table, noOfPagesToCache, totalRecords, ajaxUrl, COLUMNS, CALLBACK_FUNCTION, isFIXEDHEADER) {
		...
		loadScript(window.APPTHEMES+"ajs/datatables/jquery.dataTables.min.js", function(){
			loadScript(window.APPTHEMES+"ajs/datatables/dataTables.colVis.min.js", function(){
				loadScript(window.APPTHEMES+"ajs/datatables/dataTables.tableTools.min.js", function(){
					loadScript(window.APPTHEMES+"ajs/datatables/dataTables.bootstrap.min.js", function(){
						loadScript(window.APPTHEMES+"ajs/datatables/dataTables.fixedHeader.min.js", function(){
							loadScript(window.APPTHEMES+"ajs/datatables/datatables.responsive.min.js", pagefunction)
						});
					});
				});
			});
